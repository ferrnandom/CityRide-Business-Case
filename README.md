...
Full Business Case: You can read the complete document with all the process and conclusions here
1. Business Context
...
You can access the dashboard in Tableau Public using this link
